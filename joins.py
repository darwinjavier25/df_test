...
print("Left or LeftOuter Join: show records which join and furthermore show records in left that not cross in right")
employe_df.join(dep_df, employe_df.emp_dept_id == dep_df.dept_id, "left").show()
print("Right or RightOuter Join: show records which join and furthermore show records in right that not cross in left")
